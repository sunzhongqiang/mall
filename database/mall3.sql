...
CREATE TABLE IF NOT EXISTS `goods` (
  ...
  `title` varchar(120) DEFAULT '' COMMENT '商品名称',
  ...
  `thumb` varchar(255) DEFAULT '' COMMENT '商品相册',
  `main_img` varchar(255) DEFAULT '' COMMENT '商品主图',
...
CREATE TABLE IF NOT EXISTS `user_shop` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键,用户主键，在赋值时，请使用user_id',
