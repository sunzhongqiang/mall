//代码生成工具自动生成，请在此处填写 查询页面使用的js代码
    ...
    function deleteFun(id) {
        ...
        parent.$.messager.confirm('询问', '您是否要删除商品图片？', function(b) {
            if (b) {
                progressLoad();
                    $.post('/goods/goodsImg/delete', {
                        id : id
                    }, function(result) {
                        if (result.success) {
    ...
    function editFun(id) {
        ...
        parent.$.modalDialog({
            ...
            width : 500,
            height : 300,
            href : '/goods/goodsImg/edit?id=' + id,
            buttons : [ {
                text : '编辑',
                handler : function() {
                    parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
