//代码生成工具自动生成，请在此处填写 查询页面使用的js代码
    ...
    function deleteFun(id) {
        ...
        parent.$.messager.confirm('询问', '您是否要删除用户店铺？', function(b) {
            if (b) {
                progressLoad();
                    $.post('/user/userShop/delete', {
                        id : id
                    }, function(result) {
                        if (result.success) {
