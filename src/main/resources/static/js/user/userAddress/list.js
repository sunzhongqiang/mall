//代码生成工具自动生成，请在此处填写 查询页面使用的js代码
    ...
    $(function() {
        dataGrid = $('#dataGrid').datagrid({
            ...
            {
                width : '80',
                title : '地址类型：收货地址（recieve），退货地址(refund)',
                field : 'type',
            },
            {
                field : 'action',
    ...
    function deleteFun(id) {
        ...
        parent.$.messager.confirm('询问', '您是否要删除用户地址？', function(b) {
            if (b) {
                progressLoad();
    ...
    function editFun(id) {
        ...
        parent.$.modalDialog({
            ...
            width : 500,
            height : 300,
            href : '/user/userAddress/edit?id=' + id,
            buttons : [ {
                text : '编辑',
                handler : function() {
                    parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
