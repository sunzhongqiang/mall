...
public class DemoController extends BaseController {
	...
	public ModelAndView index(UserCondition userCondition, Pageable pageable) {
		log.info("系统用户index");
		ModelAndView modelAndView = new ModelAndView("demo/list");
		Page<User> userPage = userService.list(userCondition, pageable);
	 ...
	 * @return
	 */
	@RequestMapping("/demo/loadByOrgId")
	@ResponseBody
	...
	public ModelAndView addPage(User user) {
		ModelAndView modelAndView = new ModelAndView("demo/form");
		// 如果存在id获取该用户信息
		if (user.getId() != null) {
	...
	public ModelAndView save(User user) {
		...
		return new ModelAndView(new RedirectView("/demo/index"));
	}
	 ...
	 */
	@RequestMapping("/demo/username/exist")
	@ResponseBody
	 ...
	 * @return 处理结果
	 */
	@RequestMapping("/demo/changeUserPwd")
	@ResponseBody
	 ...
	 * @return 返回密码修改页面
	 */
	@RequestMapping("/demo/changePwdForm")
	 ...
	 * @return 修改密码界面
	 */
	@RequestMapping("/demo/editPwdForm")
	 ...
	 * @return 修改组织界面
	 */
	@RequestMapping("/demo/changeOrgForm")
	 ...
	 * @return 修改结果
	 */
	@RequestMapping("/demo/changeOrganization")
